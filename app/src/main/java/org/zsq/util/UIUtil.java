...
public class UIUtil {
    ...
    public static Drawable getDrawable(int resId) {
        return DemoApplication.getAppContext().getResources().getDrawable(resId);
    }
...
//        dialog.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
    ...
    public static int Dp2Px(float dp) {
        final float scale = DemoApplication.getAppContext().getResources().getDisplayMetrics().density;
    ...
    public static View inflate(int resId) {
        return LayoutInflater.from(DemoApplication.getAppContext()).inflate(resId, null);
    }
    ...
    public static View inflate(int resId, ViewGroup parent) {
        return LayoutInflater.from(DemoApplication.getAppContext()).inflate(resId, parent, false);
    }
